...
pub fn help() {
    ...
    add_command(&mut commands,"display","displays a row of strings as a specific type (e.g pointer, bytes) | display pointer info");
    ...
    add_command(&mut commands,"copy","copy file to a directory / another file");
